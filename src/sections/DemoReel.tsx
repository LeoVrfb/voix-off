...
interface Track {
  id: string;
  title: string;
  category: 'Commercial' | 'Audiobook';
  duration: string;
  durationSeconds: number;
}

const tracks: Track[] = [
  { id: '1', title: 'L\'Oréal Paris - Because You\'re Worth It', category: 'Commercial', duration: '00:30', durationSeconds: 30 },
  { id: '2', title: 'The Little Prince - Excerpt', category: 'Audiobook', duration: '02:15', durationSeconds: 135 },
  { id: '3', title: 'Air France - Business Class', category: 'Commercial', duration: '00:45', durationSeconds: 45 },
  { id: '4', title: 'Madame Bovary - Opening Chapter', category: 'Audiobook', duration: '03:20', durationSeconds: 200 },
  { id: '5', title: 'Chanel No. 5 - The Essence', category: 'Commercial', duration: '00:30', durationSeconds: 30 },
  { id: '6', title: 'The Night Circus - Prologue', category: 'Audiobook', duration: '04:10', durationSeconds: 250 },
  { id: '7', title: 'Dior J\'adore - New Campaign', category: 'Commercial', duration: '00:20', durationSeconds: 20 },
  { id: '8', title: 'Les Misérables - Fantine\'s Story', category: 'Audiobook', duration: '05:45', durationSeconds: 345 },
];
...
const DemoReel = () => {
  ...
  return (
    ...
    >
      <div 
        ref={containerRef}
        className="relative bg-paper min-h-screen opacity-0"
      >
        {/* Header */}
        <div 
          ref={headerRef}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="space-y-1">
              {tracks.map((track) => {
                ...
                const progress = isCurrentTrack && currentTrack 
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className={`font-serif text-lg md:text-xl truncate transition-colors duration-300 ${
                        isCurrentTrack ? 'text-ink' : 'text-ink/70 group-hover:text-ink'
                      }`}>
                        {track.title}
                      </h3>
                      <div className="flex items-center gap-3 mt-1">
                        <span className={`font-sans text-xs uppercase tracking-wider px-2 py-0.5 ${
                          track.category === 'Commercial' 
                    ...
                    <div className="hidden md:flex items-center gap-0.5 w-32 h-8">
                      {[...Array(20)].map((_, i) => {
                        const barHeight = 20 + Math.sin(i * 0.8) * 15 + Math.random() * 10;
                    ...
                    {/* Duration */}
                    <span className="font-sans text-sm text-charcoal/60 w-14 text-right">
                      {track.duration}
                    </span>
                  </div>
                );
        ...
        {/* Sticky Player Bar */}
        <div className={`fixed bottom-0 left-0 right-0 bg-paper border-t border-border/50 shadow-lg transition-transform duration-500 z-40 ${
            ...
            <div className="max-w-7xl mx-auto flex items-center gap-4 md:gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <button 
                  ...
                  className="w-10 h-10 rounded-full bg-ink text-cream flex items-center justify-center hover:bg-ink/90 transition-all hover:scale-105"
              ...
              <div className="flex-1 min-w-0 hidden sm:block">
                ...
                <p className="font-sans text-xs text-charcoal/60 uppercase tracking-wider">
